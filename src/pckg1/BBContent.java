...
public class BBContent {
	...
	public static final String File_TestData = "15BBcontent2.xlsx";
	...
	public static void main(String[] args) throws Throwable {
		...
		//	Reporter.Reportlog("Done", "Launching Url is "+getexcelurl);
			...
			//driver.switchTo().window(currentWindowHandle);
			        ...
			        WebElement Element = driver.findElement(By.xpath("//div[@id='productdescription-pane-1']"));
...
//					String Expshortdes = getExptext;
					...
					String getExptext = getCellData(i, 2);
					//Reporter.Reportlog("Done", "Exptext is "+getExptext);
					System.out.println("getExptext "+getExptext);
					

					String Actualshortdes10 = descriptn;
...
//					Thread.sleep(5000);
				...
				//	System.out.println("gettoolresult "+gettoolresult);
					...
					if(Actualshortdes10.trim().equalsIgnoreCase(Expshortdes10.trim()))
					{
...
//					//---shot description
			...
			//			String descriptn = driver.findElement(By.xpath("//div[@id='productdescription-pane-1']")).getText();
					...
					String Actualshortdes1 = driver.findElement(By.xpath("//*[@class='productKeyPopintBox']")).getText();
					Thread.sleep(3000);

					setExcelFile(Path_TestData + File_TestData, "Sheet1");
					setCellData(Actualshortdes1, i, 3);
...
//					
					setExcelFile(Path_TestData + File_TestData, "Sheet1");
					String getExptext1 = getCellData(i, 3);
