...
public class Shippingfeed {
	...
	public static final String Path_TestData = "D:\\InputFiles\\";
	public static final String File_TestData = "09MayUsshippingfeed_22.xlsx";
				...
				if(getCellData(i, 4).trim().equalsIgnoreCase(getdata1.trim()) )
					...
					System.out.println("Data from Excel1 :" + getCellData(i, 1));
					   ...
					   setExcelFile(Path_TestData + File_TestData, "Input");
						...
						{
							System.out.println("Data from Excel :" + getCellData(i, 1));
