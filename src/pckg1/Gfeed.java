...
public class Gfeed {
	...
	public static final String File_TestData = "GfeedUS0101.xlsx";
	...
	public static void main(String[] args) throws Throwable {
		...
		String currentDirectory = "D:\\Input_files2\\";
...
//				String getdata = subtotal.getText().replace("£", "");
			//	wait.until(ExpectedConditions.presenceOfElementLocated((By.xpath("//span[@itemprop='price']"))));
				wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[contains(.,'Select Design Method')] | //button[text()='Add To Cart'] | //button[contains(text(),'Proceed & Checkout')] | //button[text()='UPLOAD ARTWORK & CHECKOUT']|//button[text()='Upload Artwork & Checkout'] |//button[normalize-space()='Buy Now']")));
				Thread.sleep(2000);
				//*[@class='newPrice '] |//*[@class='newPrice']|//div[@class='newPrice prodAubosPrice']
				//getdata.replace("£", "$");
				String	getdata = driver.findElement(By.xpath("//*[@id=\"proPriceBox\"]/div[1]/div[2]/div[1]/p/span[2]|//*[@class='newPrice '] |//*[@class='newPrice']|//div[@class='newPrice prodAubosPrice']")).getText();
				getdata.replace("$", "");
