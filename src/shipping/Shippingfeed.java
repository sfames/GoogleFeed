...
public static final String File_TestData = "18AprilusShiipingfeed_23.xlsx";
...
wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[text()='Upload Artwork']|(//span[@class='controlIndicator'])[2]")));
Thread.sleep(2000);
//shortwaitForVisisble((By.xpath("//span[text()='Upload Artwork']")));
//JOptionPane.showConfirmDialog(null, 1);
//driver.findElement(By.xpath("//span[text()='Upload Artwork']|(//span[@class='controlIndicator'])[2]")).
clickjavascriptelement(driver, driver.findElement(By.xpath("//span[text()='Upload Artwork']|(//span[@class='controlIndicator'])[2]")));
...
clickjavascriptelement(driver,driver.findElement(By.xpath("//a[normalize-space()='Estimate Shipping']")));
...
String getdata = driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Super Saver'])[1]/following::span[2]")).getText();
...
System.out.println("expected Priority cell "+getCellData(i, 1));
if(getCellData(i, 1).trim().equalsIgnoreCase(priority1.trim()))
    {
